...
<html lang="en" class="no-focus">
    <head>
        ...
        <meta name="description" content="Aris PB - Membantu Anda menjadi Web Developer Profesional">
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="<?php echo base_url();?>">
                                        <i class=""></i>
                                        <span class="font-size-xl text-primary-dark">A</span><span class="font-size-xl text-success">HOTEL</span>
                                    </a>
